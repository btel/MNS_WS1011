...
\begin{enumerate}
    ...
    \item \textbf{A model of receptive fields}.  Receptive field (RF) describes
        ...
        \begin{enumerate}
            ...
            \item \label{ex:RF_questions} What are the optimal stimuli for a neuron with such a
                RF? Where would you expect to find a
                neuron with such a RF?  Why this RF characterizes a
                simple cell but not a complex cell?
...
The report should include the answers to questions in exercises
